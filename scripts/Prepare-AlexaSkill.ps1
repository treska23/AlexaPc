...
$config = Get-Content $cloudConfigPath -Raw | ConvertFrom-Json
...
$code = Get-Content $templatePath -Raw
...
Write-Host 'Código de la Skill copiado al portapapeles.' -ForegroundColor Green
